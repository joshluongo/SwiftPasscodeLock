...
open class PasscodeLockViewController: UIViewController, PasscodeLockTypeDelegate {
    ...
    @IBOutlet open var placeholderStack: UIStackView?
    ...
    open var actionCallback: ((_ worked: Bool, _ state: LockState?) -> Void)?
    ...
    @IBAction func cancelButtonTap(_ sender: UIButton) {
        ...
        actionCallback?(false, self.passcodeLockState)
    ...
    internal func animateWrongPassword() {
        ...
        placeholderStack?.transform = CGAffineTransform(translationX: -40, y: 0);
        ...
        UIView.animate(
            ...
            animations: {
                ...
                self.placeholderStack?.transform = CGAffineTransform.identity;
            },
    ...
    open func passcodeLockDidSucceed(_ lock: PasscodeLockType) {
        ...
        actionCallback?(true, self.passcodeLockState)
